class Admin::ProjectsController < Admin::BaseController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:node_id, :year_range, :name, :ongoing, :has_groups, :custom_background_colour, :custom_background_image, :description, :image, :published, :redirect_url)
    end
end
