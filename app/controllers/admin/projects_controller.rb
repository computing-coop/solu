  ...
  private
    ...
    def project_params
      params.require(:project).permit(:node_id, :year_range, :subtitle, :is_project_overview, :custom_body_background_image,
       :name, :ongoing, :has_groups, :custom_background_colour, :custom_background_image, :tags, :description, :image, :remove_custom_body_background_image, :remove_custom_background_image,
